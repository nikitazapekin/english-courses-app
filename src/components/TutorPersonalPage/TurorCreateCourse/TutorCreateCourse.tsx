...
const TutorCreateCourseComponent: React.FC = () => {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formState.for.trim()) {
            ...
            return false
            //alert("Пожалуйста, укажите, для кого предназначен курс");
            //return false;
        }
        if (!formState.logo) {
            setIsError(true)
            ...
            return false
            //alert("Пожалуйста, загрузите логотип курса");
            //return false;
        }
        if (formState.course_for.length === 0) {
            ...
            return false
            //alert("Пожалуйста, добавьте хотя бы одну целевую аудиторию");
            //return false;
        }
        if (!formState.fulldescription.trim()) {
            ...
            return false
            //alert("Пожалуйста, введите полное описание курса");
            //return false;
        }
        if (formState.for_what_reasons.length === 0) {
            ...
            return false
            //alert("Пожалуйста, добавьте хотя бы одну причину для прохождения курса");
            //return false;
        }
        if (formState.about_course.length === 0) {
            ...
            return false
            //alert("Пожалуйста, добавьте хотя бы один пункт о курсе");
            //return false;
        }
        if (!formState.tag) {
            setIsError(true)
            ...
            return false
            //alert("Пожалуйста, выберите тег для курса");
            //return false;
        }
        return true;
    };
