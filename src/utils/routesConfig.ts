...
import { ADMIN_DELETE_USERS, ADMIN_DELETED_COURSES, ADMIN_EDIT_PAGE, ADMIN_EDIT_USERS, ADMIN_PAGE, ADMIN_WARNINGS_COURSES, CARD_PAGE, CATALOG, CATALOG_QUERY, CHAT_PAGE, FOUND_COURSES, HELP_PAGE, LESSONS_EDUCATE_PAGE, LESSONS_PAGE, MAIN_PAGE, PERSONAL_PAGE, PERSONAL_PAGE_EDIT, SEARCH_PAGE, SIGN_IN, SIGN_UP, TESTING_EDUCATE_PAGE, TESTING_PAGE, TUTOR_ACHIEVEMENTS_PAGE, TUTOR_CREATE_COURSES, TUTOR_EDIT, TUTOR_PAGE, TUTOR_PERSONAL_COURSE, TUTOR_PERSONAL_COURSES, TUTOR_PERSONAL_PAGE, TUTOR_PERSONAL_RATES, TUTOR_PERSONAL_STUDENTS } from "./consts";
